...
swig -python -c++ decrypt.i
g++ -fPIC -shared decrypt.cc decrypt_wrap.cxx $obj_dir/snowboy-io.o $obj_dir/snowboy-debug.o $obj_dir/snowboy-utils.o -o _decrypt.so -I/usr/include/python2.7 -D_GLIBCXX_USE_CXX11_ABI=0
